...
export function ZeroDowntimeCTA() {
  ...
  return (
    <section className="w-full py-20 md:py-22 lg:py-30 bg-gradient-to-r from-slate-600 to-slate-600 flex justify-center">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-4 space-y-4 text-center">
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              <CircleSlash2 className="md:w-[80px] md:h-[80px] lg:w-[100px] lg:h-[100px] text-slate-50 mx-auto" />
