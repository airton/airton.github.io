...
seoTitle: "Modificando a Consulta com pre_get_posts"
description: "É um gancho que permite que você modifique a consulta principal, é muito comum você precisar alterar o conteúdo que é exibido em uma página, então vamos usar esse gancho que facilita muito o trabalho."
date: "2015-01-02"
