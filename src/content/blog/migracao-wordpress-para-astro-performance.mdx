...
seoTitle: "De WordPress para Astro: Estudo de Caso"
...
---
<a href={href} class="bg-brand px-4 py-2 rounded text-wall">
  <slot />
</a>
```
...
<a
  ...
  class="inline-flex items-center justify-center gap-2 rounded-md bg-brand px-6 py-3 text-sm font-medium !text-wall shadow hover:bg-brand-deep transition-colors no-underline !mb-0"
>
  Conheça o Astro
</a>
